...
for i, image_path in enumerate(train_images):
    ...
    detected_faces = classifier.detectMultiScale(image, scaleFactor=1.05, minNeighbors=6)
...
for i, image_path in enumerate(test_images):
    ...
    detected_faces = classifier.detectMultiScale(image_gray, scaleFactor=1.05, minNeighbors=6)
...
i have 200 dataset of basketball player face image (have 10 class and 20 image in each class (160 train and 40 test)), but it just detected 137 for train and 36 for test can yo improve it (maybe change the scale of multiscale parameter, or use preprocessing image method for each train or test loops
