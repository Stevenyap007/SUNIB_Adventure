...
for i, image_path in enumerate(train_images):
    ...
    detected_faces = classifier.detectMultiScale(image, scaleFactor=1.1, minNeighbors=5, minSize=(50, 50))
...
for i, image_path in enumerate(test_images):
    ...
    # Adjusting parameters for better face detection
    detected_faces = classifier.detectMultiScale(image_gray, scaleFactor=1.1, minNeighbors=5, minSize=(50, 50))
