...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2022 at 12:47 PM
...
--
ALTER TABLE `coffees`
  ADD CONSTRAINT `coffees_ibfk_1` FOREIGN KEY (`coffee_type_id`) REFERENCES `coffee_types` (`coffee_type_id`);

--
-- Constraints for table `transaction_details`
--
ALTER TABLE `transaction_details`
  ADD CONSTRAINT `transaction_details_ibfk_1` FOREIGN KEY (`coffee_id`) REFERENCES `coffees` (`coffee_id`),
  ADD CONSTRAINT `transaction_details_ibfk_2` FOREIGN KEY (`coffee_size_id`) REFERENCES `coffee_sizes` (`coffee_size_id`);

--
-- Constraints for table `transaction_headers`
--
ALTER TABLE `transaction_headers`
  ADD CONSTRAINT `transaction_headers_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
  ADD CONSTRAINT `transaction_headers_ibfk_2` FOREIGN KEY (`barista_id`) REFERENCES `baristas` (`barista_id`);
COMMIT;
