...
int main(){
	...
	do{
		...
		printf("HashTable using Chaining\n");
		printf("==============================\n\n");
		display();
		printf("\n1. Insert\n");
		printf("2. Search\n");
		...
		printf("4. Delete All\n");
		printf("5. Exit\n");
		printf("Choose 1 Menu: "); scanf("%d",&choose);
		getchar();
		
		switch (choose){
			case 1:
				printf("Insert Name: ");gets(name);
				insert(name);
				// getchar();
				break;
			case 2:
				printf("Search Name: ");gets(name);
				res=search(name);
				if (res==-1){
