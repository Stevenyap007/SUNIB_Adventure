...
public class BinusMain {
	...
	public void menu2() {
		...
		int price = 0;
		System.out.println("Input bouquet type [basic/pemium]: ");
		bouquetType = scan.nextLine();
		
		System.out.println("Input flower type [rose/daisy/tulip]: ");
		flowerType = scan.nextLine();
		
		if(flowerType.equals("Rose")) price += 150000;
		else if(flowerType.equals("daisy")) price += 200000;
		else if(flowerType.equals("tulip")) price += 250000;
